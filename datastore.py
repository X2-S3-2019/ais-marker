...
class DBManager:
    ...
    def initDB(self, db_name):
        ...
        crs.execute('CREATE TABLE IF NOT EXISTS groupCriteria (id INTEGER PRIMARY KEY AUTOINCREMENT, template_id, name)')
        crs.execute('CREATE TABLE IF NOT EXISTS criteria (id INTEGER PRIMARY KEY AUTOINCREMENT, groupCriterion_id, name, description)')
...
# Database functions related to the template and settings
    ...
    def getGroupCriteriaOf(self, template_id):
        ...
        crs.execute('SELECT id, name FROM groupCriteria WHERE template_id=?', (template_id,))
    ...
    def getCriteriaOfGroup(self, group_id):
        ...
        crs.execute('SELECT id, name, description FROM criteria WHERE groupCriterion_id=?', (group_id,))
...
# TODO:
    ...
    def createDefaultTemplate(self):
        ...
        crs.execute('INSERT INTO groupCriteria VALUES (?, ?, ?)', (None, template_id, 'Content Structure / Ideas'))
        ...
        crs.execute('INSERT INTO groupCriteria VALUES (?, ?, ?)', (None, template_id, 'Language and Delivery'))
        group_criterion_id = crs.lastrowid
        ...
        # Technical
        crs.execute('INSERT INTO groupCriteria VALUES (?, ?, ?)', (None, template_id, 'Technical'))
        group_criterion_id = crs.lastrowid
